...
export class UserService {
  ...
  signIn(user : any){
    return this.http.get('https://jsonplaceholder.typicode.com/users',user ).map((response : Response)=>{
    let cryptToken = this.cryptoService.encrypt('token',response[`token`])  
